...
BasicGame.Play.prototype={
	...
	breakGlasses:function(){
		if(!this.shakeTween.isRunning&&!this.moveTween.isRunning){
			...
			if(this.BrokenGlasses.frame==0){
				...
				this.M.SE.play('BreakGlasses_1',{volume:3});
	...
	genObstacles:function(){
		...
		this.Obstacles.createMultiple(2,['Asahi_2','Asahi_3','Asahi_4']);
	...
	breakGlassesScore:function(btn){
		...
		if(glasses.frame==0){
			...
			this.M.SE.play(this.rnd.pick(['Cheer_s1','Cheer_s2','Cheer_p1','Cheer_p2','Uwaa_p1','EE_p1']),{volume:1});
		}else{
			this.M.SE.play('BreakGlasses_1',{volume:3});
