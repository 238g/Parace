...
BasicGame.Play.prototype = {
	...
	tweet: function () {
		var quotes = [
			'初見です　アキ君好き',
			'この度、東京21区から出馬しました剣持刀也です。たけのこ派根絶をマニフェストに頑張っていきます。',
			'ヤァァアキモリィィイイイイ！！！！🔥🔥🔥🔥🔥',
			'虚空は嫌だ……虚空は嫌だ……',
			'いっっぱぁいヴォエッ！',
			...
			'たけのこ派の皆さんとか帰っていただいて結構ですよ？',
			'Vtuberって誕生してから道を模索すると思うんですけど、僕は気づいたら道が一本しかなかった。',
			'その先には雑草食べながら匍匐前進してる変な人しかいなかった',
			'時報ババア',
			'スヌーズババア',
			'オールウェイズババア',
			'ご忠告ありがとうございます！僕は2秒で出来ました！ありがとうございます！',
			'最初に言っておきます！僕はこの世に存在するありとあらゆるイジリを受け入れます！',
			'いいですよね虚空。かっこいいですよね',
			'ガクくんを労わってくだs',
			'レッドアイズ・アルティメットスピアー',
			'ロリコンを…享受しろ！',
			'顎にもルールはあるんですよ',
			'愛は受け取ります、毒も受け取ります。そういう男です。',
			'顎を研ぎ澄ませ',
			'ちなみにこれが今日やってたクソゲーです！',
			'無駄ですよ・・・！',
		];
